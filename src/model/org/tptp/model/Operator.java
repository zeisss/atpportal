...
public class Operator {
    ...
    public Operator ( long id, String name, int binding, String notation, String symbol, int arity, String description, String comment)
    {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "Operator [id=" + id + ";name="+ name + ";binding="+ binding + ";notation="+ notation + ";symbol="+ symbol + ";arity="+ arity + ";description="+ description + ";comment="+ comment + "]";
    }

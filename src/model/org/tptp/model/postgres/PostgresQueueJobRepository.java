...
public class PostgresQueueJobRepository extends QueueJobRepository {
    ...
    {
        String sql = "SELECT id, goal_formula, atp_id, account_id, proof_id, status, timestamp, message " +
    ...
    public Set<QueueJob> getAll() {
        String sql = "SELECT id, goal_formula, atp_id, account_id, proof_id, status, timestamp, message FROM queuejob";
    ...
    public void save(QueueJob job) {
        ...
        String sql = "INSERT INTO queuejob (id, atp_id, goal_formula, proof_id, account_id, status, timestamp, message) " +
    ...
    public void update(QueueJob job) {
        ...
        String sql = "UPDATE queuejob SET atp_id = ?, goal_formula = ?, proof_id = ?, account_id = ?, status = ?, timestamp = ?, message = ? WHERE id = ?";
